...
kidney_core_alignment = {
    'PathogenInducedResidentMemory': 'Cellranger v2.2.0',
    'Menon-Human-FSG-10x3': 'Cellranger v3',
    'SuryawanshiKidneyAllografts': 'STAR 2.5.1a',
    'ChimerismKidneyTransplantReject': 'Cellranger v3.0',
    'ImmuneLandscapeccRCC': 'Cellranger v3.0.1',
